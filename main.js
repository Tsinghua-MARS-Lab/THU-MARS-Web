const main = {
  ...
  about_our_lab: 'MARS Lab is an interdisciplinary AI lab at IIIS, Tsinghua University, led by Professor Hang Zhao. We are working on a range of moonshot problems, our current focus are on on four areas: (1) Multimodal learning, (2) Autonomous Driving, (3) Robotics, (4) Sensors. \n MARS Lab多模态学习实验室，是清华大学交叉信息院下的交叉学科人工智能实验室，由赵行教授领导。我们尝试解决一系列探索性的AI问题，当前我们主要研究以下几个方向：（1）多模态学习，（2）自动驾驶，（3）机器人，（4）传感器。',
